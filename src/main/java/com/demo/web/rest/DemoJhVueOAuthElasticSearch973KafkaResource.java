...
@RestController
@RequestMapping("/api/demo-jh-vue-o-auth-elastic-search-973-kafka")
public class DemoJhVueOAuthElasticSearch973KafkaResource {

    private final Logger log = LoggerFactory.getLogger(DemoJhVueOAuthElasticSearch973KafkaResource.class);
    ...
    public DemoJhVueOAuthElasticSearch973KafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
