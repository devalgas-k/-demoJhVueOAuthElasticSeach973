        ...
        <thead>
          <tr>
            ...
            <th scope="row" v-on:click="changeOrder('departmentName')">
              <span v-text="$t('demoJhVueOAuthElasticSearch973App.department.departmentName')">Department Name</span>
            ...
            <th scope="row" v-on:click="changeOrder('location.id')">
              <span v-text="$t('demoJhVueOAuthElasticSearch973App.department.location')">Location</span>
