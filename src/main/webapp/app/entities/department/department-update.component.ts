    ...
    if (this.department.id) {
      this.departmentService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('demoJhVueOAuthElasticSearch973App.department.updated', { param: param.id });
      ...
      this.departmentService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('demoJhVueOAuthElasticSearch973App.department.created', { param: param.id });
