    ...
    if (this.subject.id) {
      this.subjectService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('demoJhVueOAuthElasticSearch973App.subject.updated', { param: param.id });
      ...
      this.subjectService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('demoJhVueOAuthElasticSearch973App.subject.created', { param: param.id });
