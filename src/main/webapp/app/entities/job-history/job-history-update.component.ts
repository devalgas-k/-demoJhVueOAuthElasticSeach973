    ...
    if (this.jobHistory.id) {
      this.jobHistoryService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('demoJhVueOAuthElasticSearch973App.jobHistory.updated', { param: param.id });
      ...
      this.jobHistoryService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('demoJhVueOAuthElasticSearch973App.jobHistory.created', { param: param.id });
