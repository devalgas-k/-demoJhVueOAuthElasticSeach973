...
import com.demo.repository.search.JobSearchRepository;
    ...
    void putExistingJob() throws Exception {
        ...
        await()
            ...
            .untilAsserted(() -> {
                ...
                assertThat(testJobSearch.getMinSalary()).isEqualByComparingTo(UPDATED_MIN_SALARY);
                assertThat(testJobSearch.getMaxSalary()).isEqualTo(UPDATED_MAX_SALARY);
                assertThat(testJobSearch.getSubSalary()).isEqualTo(UPDATED_SUB_SALARY);
                assertThat(testJobSearch.getTotalSalary()).isEqualTo(UPDATED_TOTAL_SALARY);
                assertThat(testJobSearch.getDate()).isEqualTo(UPDATED_DATE);
                assertThat(testJobSearch.getCodeCode()).isEqualTo(UPDATED_CODE_CODE);
                assertThat(testJobSearch.getProfil()).isEqualTo(UPDATED_PROFIL);
                assertThat(testJobSearch.getProfilContentType()).isEqualTo(UPDATED_PROFIL_CONTENT_TYPE);
            });
    }
