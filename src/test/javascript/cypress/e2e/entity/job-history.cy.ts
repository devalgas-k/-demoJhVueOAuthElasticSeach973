...
describe('JobHistory e2e test', () => {
  ...
  describe('new JobHistory page', () => {
    ...
    it('should create an instance of JobHistory', () => {
      cy.get(`[data-cy="startDate"]`).type('2024-08-31T20:44').blur().should('have.value', '2024-08-31T20:44');

      cy.get(`[data-cy="endDate"]`).type('2024-08-31T03:42').blur().should('have.value', '2024-08-31T03:42');

      cy.get(`[data-cy="language"]`).select('SPANISH');

      cy.setFieldImageAsBytesOfEntity('file', 'integration-test.png', 'image/png');

      cy.get(`[data-cy="date"]`).type('2024-08-31T22:40').blur().should('have.value', '2024-08-31T22:40');
