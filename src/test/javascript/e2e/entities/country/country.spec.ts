...
describe('Country e2e test', () => {
  ...
  describe('Create flow', () => {
    it('should load create Country page', async () => {
      ...
      expect(await updatePage.title.getAttribute('id')).to.match(/demoJhVueOAuthElasticSearch973App.country.home.createOrEditLabel/);
    });
    ...
    describe('Details, Update, Delete flow', () => {
      after(async () => {
        ...
        expect(await deleteDialog.title.getAttribute('id')).to.match(/demoJhVueOAuthElasticSearch973App.country.delete.question/);
