...
describe('Location e2e test', () => {
  ...
  describe('Create flow', () => {
    it('should load create Location page', async () => {
      ...
      expect(await updatePage.title.getAttribute('id')).to.match(/demoJhVueOAuthElasticSearch973App.location.home.createOrEditLabel/);
    });
    ...
    describe('Details, Update, Delete flow', () => {
      after(async () => {
        ...
        expect(await deleteDialog.title.getAttribute('id')).to.match(/demoJhVueOAuthElasticSearch973App.location.delete.question/);
