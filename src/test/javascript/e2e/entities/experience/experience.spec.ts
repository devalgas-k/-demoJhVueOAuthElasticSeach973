...
describe('Experience e2e test', () => {
  ...
  describe('Create flow', () => {
    it('should load create Experience page', async () => {
      ...
      expect(await updatePage.title.getAttribute('id')).to.match(/demoJhVueOAuthElasticSearch973App.experience.home.createOrEditLabel/);
    });
    ...
    describe('Details, Update, Delete flow', () => {
      after(async () => {
        ...
        expect(await deleteDialog.title.getAttribute('id')).to.match(/demoJhVueOAuthElasticSearch973App.experience.delete.question/);
